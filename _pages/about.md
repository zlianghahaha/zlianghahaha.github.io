...
# Publications
* **Zhiding Liang^**, Jinglei Cheng^, Hang Ren, Hanrui Wang, Fei Hua, Yongshan Ding, Fred Chong, Song Han, Xuehai Qian, Yiyu Shi, "NAPA: Intermediate-level Variational Native-pulse Ansatz for Variational Quantum Algorithms". ([TCAD](https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=43)), This work also **highlighted** by **[IBM Qiskit](https://medium.com/qiskit/enhance-variational-quantum-algorithms-with-qiskit-pulse-and-qiskit-dynamics-768249daf8dd)**.
